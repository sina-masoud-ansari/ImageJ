...
public class ShortProcessor extends ImageProcessor {
	...
	*/
	...
	/**
	 * Original approach for salt and pepper filter
	 */
	@Override
	...
	public void salt_and_pepper_SERIAL(double percent) {
		...
		for (int i = 0; i < div.numThreads; i++) {
			threads[i] = new Thread(getSaltAndPepperRunnable(nForEachTask,div.getDivision(i),div.divs.length));
		}
	...
	/**
	 * Returns the next double pseudo random number
	 * @param min
	 * @param max
	 * @param r
	 * @return
	...
	/**
	 * Returns a runnable for the salt and pepper filter
	 */
	...
	/**
	 * ParaTask approach for salt and pepper approach
	 */
	...
	/**
	 * ExecutorService approach for salt and pepper filter
	 */
	...
	/**
	 * Fork join approach for salt and pepper filter
	 */
